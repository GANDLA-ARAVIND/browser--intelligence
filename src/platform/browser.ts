...
export function onInstalled(handler: (reason: InstallReason) => void): void {
  chrome.runtime.onInstalled.addListener((details) => handler(details.reason as InstallReason));
}
